...
// src/code-view.js
var keywordWords = /* @__PURE__ */ new Set([
  "abstract",
  "allocated",
  "as",
  "assert",
...
var definitionWords = /* @__PURE__ */ new Set([
  "class",
  "const",
  "constructor",
  "datatype",
...
var typeWords = /* @__PURE__ */ new Set([
  "bool",
  "char",
  "int",
  "imap",
...
var atomWords = /* @__PURE__ */ new Set(["false", "null", "true"]);
...
var dafnyLanguage = StreamLanguage.define({
  name: "dafny",
...
var dafnyHighlight = HighlightStyle.define([
...
var makeEditorTheme = (dark) => EditorView.theme({
  "&": {
    height: "100%",
    color: "var(--text)",
...
var boogieLanguage = StreamLanguage.define({
  name: "boogie",
...
var BOOGIE_KEYWORDS = /* @__PURE__ */ new Set([
  "type",
  "const",
  "function",
  "axiom",
...
var BOOGIE_TYPES = /* @__PURE__ */ new Set(["bool", "int", "real", "bv8", "bv16", "bv32", "bv64"]);
var SMT_COMMANDS = /* @__PURE__ */ new Set([
  "assert",
  "check-sat",
  "check-sat-assuming",
  "declare-const",
...
var SMT_DECLARES = /* @__PURE__ */ new Set([
  "declare-const",
  "declare-datatype",
  "declare-fun",
  "declare-sort",
...
var SMT_BINDERS = /* @__PURE__ */ new Set(["forall", "exists", "let", "lambda", "match", "!", "as", "par"]);
var SMT_BUILTINS = /* @__PURE__ */ new Set([
  "and",
  "or",
  "not",
  "=>",
...
var SMT_SORTS = /* @__PURE__ */ new Set([
  "Bool",
  "Int",
  "Real",
  "String",
...
var smtLanguage = StreamLanguage.define({
  name: "smtlib",
